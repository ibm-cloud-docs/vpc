...
# Service dependency map for IBM Cloud Virtual Private Cloud
...
{: #service-dependencies-for-is-vpc}
...
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Virtual Private Cloud - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-vpc-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-vpc-Data-and-Control-plane-deployment}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Business Support Services | Availability, Change management, Instance control | No | Both |  Same region  |
...
| IBM Cloud CLI  | Availability, Instance control | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| {{site.data.keyword.cloud-shell_full}} | Availability, Instance control, Operations | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
| IBM Cloud Log Routing | Access management, Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
| IBM Cloud Global Search and Tagging | Availability, Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| {{site.data.keyword.atracker_full}} | Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
| {{site.data.keyword.monitoringlong}} | Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
| corporate-qradar | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| OSS Platform | Availability, Operations | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM GitHub Enterprise | Availability, Change management, Instance control | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Classic NTP Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| corporate-uptycs | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| {{site.data.keyword.pag_full}} | Availability, Security compliance | No | Both |  Same region  |
| {{site.data.keyword.metrics_router_full}} | Access management, Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
| SOS SIEM | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Virtual Private Cloud - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-vpc-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-vpc-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Backup for VPC
{: #service-dependencies-for-is-backup-policy}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.block_storage_is_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same zone  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| IBM Cloud Virtual Server for VPC | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same zone  |
| {{site.data.keyword.vpc_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same zone  |
| IBM Cloud Block Storage Snapshots for VPC | Availability, Disaster recovery, Instance control, Security compliance | No | Both |  Same zone  |
| IBM Cloud Databases | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
...
| {{site.data.keyword.iamlong}} | Access management, Availability, Change management, Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Cloud Object Storage (IaaS) | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Backup for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-backup-policy-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-backup-policy-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Backup for VPC - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-backup-policy-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-backup-policy-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| corporate-qradar| Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| corporate-uptycs| Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Backup for VPC - Data and Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-backup-policy-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-backup-policy-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.block_storage_is_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | ngdc-data-plane |  Same data center  |
| IBM Cloud Virtual Server for VPC | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| {{site.data.keyword.vpc_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| IBM Cloud Block Storage Snapshots for VPC | Availability, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| IBM Cloud Databases | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
| {{site.data.keyword.cis_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| {{site.data.keyword.iamlong}} | Access management, Availability, Change management, Instance control, Security compliance | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, Disaster recovery, Instance control | No | ngdc-data-plane |  Same region  |
| IBM Cloud Object Storage (IaaS) | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Backup for VPC - Data plane deployment for NGDC service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-backup-policy-Data-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-backup-policy-Data-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.keymanagementservicefull}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
| IBM Cloud Classic NTP Servers | Availability, Change management, Instance control | No | ngdc-data-plane |  Same data center  |
| IBM Cloud CLI  | Availability | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| {{site.data.keyword.atracker_full}} | Availability, Operations, Security compliance | No | ngdc-data-plane |  us-east  |
| IBM Cloud Business Support Services | Availability, Instance control | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Global Search and Tagging | Availability, Instance control | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| {{site.data.keyword.monitoringlong}} | Availability, Operations | No | ngdc-data-plane |  Same region  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Backup for VPC - Data plane deployment for NGDC service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-backup-policy-Data-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-backup-policy-Data-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Bare Metal Servers for VPC
{: #service-dependencies-for-is-bare-metal-server}
...
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-bare-metal-server-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| corporate-qradar| Security compliance | No | Both |  Same region  |
...
{: #service-dependencies-for-is-dedicated-host}
...
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Dedicated Host for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-dedicated-host-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-dedicated-host-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Dedicated Host for VPC - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-dedicated-host-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-dedicated-host-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Virtual Private Endpoint for VPC
{: #service-dependencies-for-is-endpoint-gateway}


## Data and Control plane deployment
{: #data-and-control-plane-deployment}

The following dependencies apply to the following deployment locations: Dallas 10, Dallas 12, Dallas 13, Dallas 14, Frankfurt 02, Frankfurt 04, Frankfurt 05, London 02, London 04, London 05, London 06, Madrid 02, Madrid 04, Madrid 05, Osaka 21, Osaka 22, Osaka 23, Sao Paulo 01, Sao Paulo 04, Sao Paulo 05, Sydney 01, Sydney 04, Sydney 05, Tokyo 02, Tokyo 04, Tokyo 05, Toronto 01, Toronto 04, Toronto 05, Washington DC 04, Washington DC 06, Washington DC 07.
...
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Virtual Private Endpoint for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-endpoint-gateway-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-endpoint-gateway-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| SOS SIEM | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| corporate-uptycs | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| corporate-magna | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Virtual Private Endpoint for VPC - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-endpoint-gateway-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
...
{: row-headers}
{: caption="IBM Cloud Virtual Private Endpoint for VPC - Data and Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-endpoint-gateway-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-endpoint-gateway-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| corporate-magna | Availability, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Virtual Private Endpoint for VPC - Data and Control plane deployment NGDC service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-endpoint-gateway-Data-and-Control-plane-deployment-NGDC"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-endpoint-gateway-Data-and-Control-plane-deployment-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| PagerDuty| Operations | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Virtual Private Endpoint for VPC - Data and Control plane deployment NGDC service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-endpoint-gateway-Data-and-Control-plane-deployment-NGDC"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-endpoint-gateway-Data-and-Control-plane-deployment-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Flow Logs for VPC
{: #service-dependencies-for-is-flow-log-collector}
...
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| {{site.data.keyword.cis_full}} | Availability, Instance control | No | Both |  Same region  |
| {{site.data.keyword.cos_full}} | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same data center  |
...
| {{site.data.keyword.atracker_full}} | Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Flow Logs for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
...
| {{site.data.keyword.atracker_full}} | Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Flow Logs for VPC - ngdc-data-control-plane service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-flow-log-collector-ngdc-data-control-plane"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-flow-log-collector-ngdc-data-control-plane}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, configuration-management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Virtual Server for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-instance-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-instance-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Hyper Protect Crypto Services | Availability, Change management, configuration-management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
...
| IBM Cloud Log Routing | Availability, configuration-management | No | Both |  Same region  |
...
{: tab-group="service-dependency-data-for-is-instance-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-instance-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| VPC IaaS NextGen control plane (genctl)| none | No | Both |  Same region  |
...
{: tab-group="service-dependency-data-for-is-instance-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-instance-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Auto Scale for VPC
{: #service-dependencies-for-is-instance-group}
...
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Auto Scale for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-instance-group-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-instance-group-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Auto Scale for VPC - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-instance-group-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-instance-group-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud File Storage for Virtual Private Cloud
{: #service-dependencies-for-is-share}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.vpc_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | Yes | Both |  Same zone  |
| VPC Regional Infrastructure API Service | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same data center  |
| {{site.data.keyword.iamlong}} | Access management, Availability, Change management, Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| IBM Cloud Classic NTP Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| {{site.data.keyword.cis_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud File Storage for Virtual Private Cloud - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Classic Infrastructure Resource Management| Change management | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Public IP Address Management| Change management | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud File Storage for Virtual Private Cloud - Data and Control plane deployment service dependency information - Medium dependencies" caption-side="top"}
...
{: #service-dependencies-for-is-snapshot}
...
| IBM Cloud Hyper Protect Crypto Services | Availability | Yes | Both |  Same region  |
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
...
| IBM Cloud Virtual Server for VPC | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Block Storage Snapshots for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-snapshot-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-snapshot-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Global Search and Tagging | Availability, Change management, Instance control | No | Both |  Same region  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | Both |  Same region  |
| IBM Cloud Classic NTP Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| {{site.data.keyword.monitoringlong}} | Availability, Change management, Instance control, Operations | No | Both |  Same region  |
| IBM Cloud Image Service for VPC | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
| {{site.data.keyword.block_storage_is_full}} | Availability, Change management, Disaster recovery, Instance control | Yes | Both |  Same region  |
| {{site.data.keyword.atracker_full}} | Availability, Operations, Security compliance | No | Both |  us-east  |
{: row-headers}
{: caption="IBM Cloud Block Storage Snapshots for VPC - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-snapshot-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-snapshot-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
{: tab-group="service-dependency-data-for-is-snapshot-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-snapshot-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
{: row-headers}
{: caption="IBM Cloud Block Storage Snapshots for VPC - Data and Control plane deployment for NGDC service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-snapshot-Data-and-Control-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-snapshot-Data-and-Control-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.atracker_full}} | Availability, Operations, Security compliance | No | Both |  us-east  |
{: row-headers}
{: caption="IBM Cloud Block Storage Snapshots for VPC - Data and Control plane deployment for NGDC service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-snapshot-Data-and-Control-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-snapshot-Data-and-Control-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Block Storage for Virtual Private Cloud
{: #service-dependencies-for-is-volume}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| VPC Regional Infrastructure API Service | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
| {{site.data.keyword.cis_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  ibm-intranet  |
| IBM Cloud Hyper Protect Crypto Services | Availability | Yes | Both |  Same region  |
| {{site.data.keyword.iamlong}} | Access management, Availability, Change management, Instance control, Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Block Storage for Virtual Private Cloud - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-volume-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-volume-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Global Search and Tagging | Availability, Instance control, Security compliance | No | Both |  Same region  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | Both |  Same region  |
| {{site.data.keyword.keymanagementservicefull}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Block Storage for Virtual Private Cloud - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-volume-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-volume-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Hyper Protect Crypto Services| none | No | Both |  Same region  |
...
{: tab-group="service-dependency-data-for-is-volume-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-volume-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| VPC Regional Infrastructure API Service | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
| {{site.data.keyword.cis_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  ibm-intranet  |
| IBM Cloud Hyper Protect Crypto Services | Availability | Yes | ngdc-data-plane |  Same region  |
| {{site.data.keyword.iamlong}} | Access management, Availability, Change management, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
{: row-headers}
{: caption="IBM Cloud Block Storage for Virtual Private Cloud - Data plane deployment for NGDC service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-volume-Data-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-volume-Data-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Global Search and Tagging | Availability, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | ngdc-data-plane |  Same region  |
| {{site.data.keyword.keymanagementservicefull}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
{: row-headers}
{: caption="IBM Cloud Block Storage for Virtual Private Cloud - Data plane deployment for NGDC service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-volume-Data-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-volume-Data-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Hyper Protect Crypto Services| none | No | ngdc-data-plane |  Same region  |
...
| corporate-qradar| Security compliance | No | ngdc-data-plane |  Same data center  |
| corporate-uptycs| Security compliance | No | ngdc-data-plane |  Same data center  |
{: row-headers}
...
{: tab-group="service-dependency-data-for-is-volume-Data-plane-deployment-for-NGDC"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-volume-Data-plane-deployment-for-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud VPN for VPC Site to Site Gateway
{: #service-dependencies-for-is-vpn}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.vpc_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same zone  |
...
| IBM Cloud VPN for VPC Site to Site Gateway | Availability | No | data-plane |  Same region  |
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - Data plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-Data-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-vpn-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Business Support Services | Availability, Instance control | No | data-plane |  Same region  |
...
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - Data plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-Data-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-vpn-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud VPN for VPC Site to Site Gateway| none | No | data-plane |  Same region  |
...
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - Data plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-Data-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-vpn-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.vpc_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| {{site.data.keyword.block_storage_is_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| {{site.data.keyword.messagehub_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same region  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | ngdc-data-plane |  Same data center  |
| IBM Cloud File Storage for Virtual Private Cloud | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| {{site.data.keyword.cos_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  us-south  |
| {{site.data.keyword.iamlong}} | Access management, Availability, Change management, Instance control, Security compliance | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Virtual Server for VPC | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | ngdc-data-plane |  Same zone  |
| IBM Cloud VPN for VPC Site to Site Gateway | Availability | No | ngdc-data-plane |  Same region  |
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - NGDC Data plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-NGDC-Data-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-vpn-NGDC-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Business Support Services | Availability, Instance control | No | ngdc-data-plane |  Same region  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - NGDC Data plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-NGDC-Data-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-vpn-NGDC-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud VPN for VPC Site to Site Gateway| none | No | ngdc-data-plane |  Same region  |
| IBM Cloud Classic NTP Servers| Operations | No | ngdc-data-plane |  Same data center  |
| SOS Compliance Reporting| none | No | ngdc-data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - NGDC Data plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-NGDC-Data-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-vpn-NGDC-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.tg_full}} | Availability, Operations | No | control-plane |  Same region  |
...
| IBM Cloud Kubernetes Service and Red Hat OpenShift on IBM Cloud and ROVS | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | control-plane |  Same region  |
...
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-vpn-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| IBM Cloud Business Support Services | Availability, Instance control | No | control-plane |  Same region  |
...
| IBM Cloud Global Search and Tagging | Availability | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-vpn-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.atracker_full}}| Change management, Operations, Security compliance | No | control-plane |  Same region  |
| IBM Cloud Log Routing| Change management, Operations | No | control-plane |  Same region  |
{: row-headers}
...
| {{site.data.keyword.pag_full}}| Operations | No | control-plane |  us-south  |
| {{site.data.keyword.logs_full}}| Access management, Operations, Security compliance | No | control-plane |  Same region  |
| IBM Cloud Business Support Services| none | No | control-plane |  Same region  |
| SOS Compliance Reporting| none | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| SOS SIEM| Operations, Security compliance | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| corporate-palo-alto| Operations, Security compliance | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
{: row-headers}
{: caption="IBM Cloud VPN for VPC Site to Site Gateway - Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-vpn-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-vpn-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud VPN for VPC Client to Site Server
{: #service-dependencies-for-is-vpn-server}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.cis_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same region  |
| {{site.data.keyword.vpc_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same zone  |
| IBM Cloud Virtual Server for VPC | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same zone  |
| {{site.data.keyword.block_storage_is_full}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same zone  |
| IBM Cloud File Storage for Virtual Private Cloud | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same zone  |
...
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-vpn-server-Data-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Log Routing | Access management, Availability, Instance control, Operations, Security compliance | No | data-plane |  Same region  |
{: row-headers}
...
| SOS Compliance Reporting| none | No | data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| corporate-palo-alto| Security compliance | No | data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
...
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-vpn-server-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| IBM Cloud Log Routing | Access management, Availability, Instance control, Operations, Security compliance | No | control-plane |  Same region  |
| IBM Cloud Console | Availability, Instance control, Operations | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
...
| IBM Cloud Classic NTP Servers| Operations | No | control-plane |  Same data center  |
| corporate-uptycs| Security compliance | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| corporate-palo-alto| Security compliance | No | control-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
...
{: #service-dependencies-for-is-load-balancer}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.cis_full}} | Availability, Disaster recovery, Instance control, Operations, Security compliance | No | Both |  Same region  |
| IBM Cloud Classic DNS Servers | Availability, Change management, Instance control | No | Both |  Same data center  |
| {{site.data.keyword.iamlong}} | Access management, Availability, Operations, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Load Balancer for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-load-balancer-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-load-balancer-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.secrets-manager_full}} | Availability, Instance control, Operations, Security compliance | No | Both |  Same region  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
{: row-headers}
{: caption="IBM Cloud Load Balancer for VPC - Data and Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-is-load-balancer-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-load-balancer-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
{: row-headers}
{: caption="IBM Cloud Load Balancer for VPC - Data and Control plane deployment service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-load-balancer-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-load-balancer-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}

## IBM Cloud Image Service for VPC
{: #service-dependencies-for-is-image}
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
| {{site.data.keyword.cos_full}} | Availability, Disaster recovery | No | Both |  Customer selected  |
| {{site.data.keyword.cos_full}} | Availability, Disaster recovery | No | Both |  Customer selected  |
| {{site.data.keyword.messagehub_full}} | Availability, Operations | No | Both |  Same region  |
...
| {{site.data.keyword.cis_full}} | Access management, Availability, Instance control | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Image Service for VPC - Data and Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-image-Data-and-Control-plane-deployment"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-image-Data-and-Control-plane-deployment}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.iamlong}} | Access management, Availability, Instance control | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Private Paths for VPC - Data and Control plane deployment NGDC service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
{: tab-group="service-dependency-data-for-is-private-path-service-gateway-Data-and-Control-plane-deployment-NGDC"}
{: class="comparison-tab-table"}
{: #critical-service-dependencies-for-is-private-path-service-gateway-Data-and-Control-plane-deployment-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
{: tab-group="service-dependency-data-for-is-private-path-service-gateway-Data-and-Control-plane-deployment-NGDC"}
{: class="comparison-tab-table"}
{: #significant-service-dependencies-for-is-private-path-service-gateway-Data-and-Control-plane-deployment-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
...
| {{site.data.keyword.atracker_full}}| Security compliance | No | Both |  Same region  |
{: row-headers}
{: caption="IBM Cloud Private Paths for VPC - Data and Control plane deployment NGDC service dependency information - Minimal dependencies" caption-side="top"}
{: tab-title="Minimal dependencies"}
{: tab-group="service-dependency-data-for-is-private-path-service-gateway-Data-and-Control-plane-deployment-NGDC"}
{: class="comparison-tab-table"}
{: #minimal-service-dependencies-for-is-private-path-service-gateway-Data-and-Control-plane-deployment-NGDC}
{: summary="Use the buttons for the dependency level to change the context of the table. This table has row and column headers. The row headers detail the specific dependent service. The column headers identify the details about the dependency and its impact. To understand the details about each dependency, navigate to the row to find the dependency that you need more information about interested in."}
