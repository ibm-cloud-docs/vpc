...
On 31 December 2022, support for Certificate Manager will be removed and any existing instances will be deleted. The strategic alternative for managing certificates in IBM Cloud is Secrets Manager. For more information, see [Migrating certificates from Certificate Manager](/docs/secrets-manager?topic=secrets-manager-migrate-from-certificate-manager).
{: important}
