...
Private Path allows connection between your VPC and another service like Code Engine without compromising security or putting your VPC at risk.

Code engine is unlike other compute services, with it’s dynamic scaling aspects. Code engine provides a multi-tenant environment with infrastructure for clients that allows them flexible consumption capacity. 
