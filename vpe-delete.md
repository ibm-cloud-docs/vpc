...
2. Click the Actions menu ![Actions menu](../icons/action-menu-icon.svg "Actions") next to the endpoint gateway that you want to delete, then click **Delete**. Click **Delete** again to confirm the deletion.
