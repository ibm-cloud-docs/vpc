...
- The `l4` GPU profiles are only available in the EU Germany (Frankfurt), Australia (Sydney), and Japan (Tokyo) regions.
...
### Considerations for v100, a100, and l4 GPU profiles
{: #considerations-gpu-profiles}

When you create a `-v100`, `-a100`, and `l4` GPU profile, keep the following recommendations in mind.
