...
* Get the IBM intermediate certificate. The following table lists the expiry dates for the intermediate certificates based on the version of the image.
    ...
    | -------- | ----------- | ----------- |
    | `ibm-hyper-protect-container-runtime-1-0-s390x20` | [certificate](https://cloud.ibm.com/media/docs/downloads/hyper-protect-container-runtime/ibm-hyper-protect-container-runtime-1-0-s390x-19-intermediate.crt){: external} | 01 September 2026 |
