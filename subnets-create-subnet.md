...
The **Reserved IPs** tab is a list of all reserved IPs associated with the subnet. For more information about Reserved IPs, see [Managing IP addresses](/docs/vpc?topic=vpc-managing-ip-addresses&interface=ui).
...
|**ip_version**  \n string|The IP version(s) to support for this subnet. **Allowable values:** `[ipv4]`|
|**name**  \n Required  \n string | The name for this subnet. The name must not be used by another subnet in the VPC. If unspecified, the name will be a hyphenated list of randomly-selected words.  \n **Possible values:** 1 ≤ length ≤ 63, Value must match regular expression  `^([a-z]&verbar;[a-z][-a-z0-9]*[a-z0-9])$`  \n **Example:** `my-subnet`|
...
|**public_gateway**  \n string |The public gateway to use for internet-bound traffic for this subnet. If unspecified, the subnet will not be attached to a public gateway.  \n One of: `PublicGatewayIdentityById`, `PublicGatewayIdentityByCRN`, `PublicGatewayIdentityByHref`|
...
|**ip_version**  \n Always included  \n string|The IP version(s) supported by this subnet.  \n **Possible values:** `[ipv4]`
...
|**name**  \n Always included  \n string|The name for this subnet. The name is unique across all subnets in the VPC.  \n **Possible values:** 1 ≤ length ≤ 63, Value must match regular expression  `^-?([a-z]&verbar;[a-z][-a-z0-9]*[a-z0-9]|[0-9][-a-z0-9]*([a-z]|[-a-z][-a-z0-9]*[a-z0-9]))$`  \n **Example:** `my-subnet`|
