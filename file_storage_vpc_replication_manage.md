...
You can delete file shares (source or replica) in the [console](/docs/vpc?topic=vpc-file-storage-managing&interface=ui#delete-vpc-file-resources), from the [CLI](/docs/vpc?topic=vpc-file-storage-managing&interface=cli#delete-vpc-file-resources), with the [API](/docs/vpc?topic=vpc-file-storage-managing&interface=api#delete-vpc-file-resources), or [Terraform](/docs/vpc?topic=vpc-file-storage-managing&interface=terraform#delete-vpc-file-resources).
