...
1. Make sure that you complete the preparation in the readme file first. 
2. The following list gives you an overview of the available samples. See the repo for the most recent samples and the readme file in the subdirectory of each sample for detailed instructions. 
