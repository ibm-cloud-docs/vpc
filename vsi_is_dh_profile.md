...
New 3rd generation profiles are available in the Chennai - Airtel, Dallas, Frankfurt, London, Madrid, Montreal, Mumbai - Airtel, and Toronto regions to create dedicated hosts on hardware that uses 4th Generation Intel&reg; Xeon&reg; Scalable processors, the Intel 8474C processor (previously code named Sapphire Rapids).
{: preview}
...
New 3rd generation profiles are available in the Chennai - Airtel, Dallas, London, Madrid, Montreal, Mumbai - Airtel, and Toronto regions to create dedicated hosts on hardware that uses 4th Generation Intel&reg; Xeon&reg; Scalable processors, the Intel 8474C processor (previously code named Sapphire Rapids).
{: preview}
