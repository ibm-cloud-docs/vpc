...
1. Initialize ilab using the `ilab config init` command. For more information, see the [Red Hat Enterprise Linux AI CLI reference](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux_ai/1.5#rhelai_cli_ref){: external}.
