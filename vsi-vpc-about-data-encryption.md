...
After provisioning the key management service, you must authorize access between Cloud Block Storage (source service) and the KMS. For custom images, also authorize between Image Service for VPC and IBM Cloud Object Storage.
