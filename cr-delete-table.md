...
1. From the [{{site.data.keyword.cloud_notm}} console](/login){: external}, select the **Menu** icon ![menu icon](/images/menu_icon.png), then click **> VPC Infrastructure** ![VPC icon](../../icons/vpc.svg) **>Routing tables** in the Network section. The routing tables for VPC page appear.
