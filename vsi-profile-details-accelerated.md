...
- Cloud networking: virtio
- Block boot volume: virtio
   - Exception: vscsi for most Windows-based instances. Windows instances that run on second-generation storage volumes, and Windows instances with secure boot enabled that run Windows Server 2022 or newer, use virtio.
- Block data volumes: virtio
