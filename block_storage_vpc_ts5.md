...
If you remove IAM authorization from Cloud Block Storage to the KMS before you delete all customer-managed volumes or images, the root key fails to unregister from the resource.
{: tsCauses}
