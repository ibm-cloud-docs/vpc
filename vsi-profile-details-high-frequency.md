...
For {{site.data.keyword.block_storage_is_short}}, only first-generation volumes from the tiered and custom volume profile families can be used as boot volumes for hx4da instances.
