...
You can bind, unbind, and move public address ranges to a VPC in an availability zone with the UI, CLI, and API.  
{: shortdesc}
...
* The following [IAM permissions](/docs/vpc?topic=vpc-about-par&interface=ui#par-access-management) are required to bind or unbind a public address range:
...
You can bind, unbind, and move a public address range to a VPC in an availability zone in the UI.

### Binding a public address range in the UI
{: #bind-par-ui}
...
1. From the Bind public address range side panel, choose the VPC (and its availability zone) to which you want to bind the address range.
1. Click **Bind** to bind the public address range to the VPC.

### Unbinding a public address range in the UI
{: #unbind-par-ui}
...
To move a public address range in the UI, follow these steps:
...
1. From the address range side panel, choose the VPC (and its availability zone) to which you want to move the address range.
