...
You can also create a cross-region copy of a snapshot in Sydney, Sao Paulo, Osaka, and London regions. Cross-region copies of snapshots taken of encrypted volumes or volumes that are bigger than 10 TB are not supported in this release.
