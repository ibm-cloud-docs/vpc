...
For more information on setting up security groups by using the CLI, see [Security groups](https://cloud.ibm.com/docs/vpc?topic=vpc-set-up-environment&interface=cli#security-groups-cli-ref){: external}.
