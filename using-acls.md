...
For information about using ICMP, TCP, and UDP protocols in your ACL rules, see [Understanding internet communication protocols](/docs/network-infrastructure?topic=network-infrastructure-understanding-internet-communication-protocols).
...
![Figure showing an example ACL scenario](images/vpc-acls.svg "Figure showing an example ACL scenario"){: caption="Figure 1. ACL with two subnets" caption-side="top"}
