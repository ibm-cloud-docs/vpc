...
New 3rd generation profiles are available in the Dallas, London, Frankfurt, Washington DC, and Toronto regions to create dedicated hosts on hardware that uses 4th Generation Intel&reg; Xeon&reg; Scalable processors, the Intel 8474C processor (previously code named Sapphire Rapids).
{: preview}
