...
For more examples of the `ibmcloud is instance-group-create` command, see the [VPC CLI reference](docs/vpc?topic=vpc-infrastructure-cli-plugin-vpc-reference#???).
