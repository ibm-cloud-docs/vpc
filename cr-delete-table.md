...
1. From the [{{site.data.keyword.cloud_notm}} console](/login){: external}, select the menu icon ![Menu icon](images/menu_icon.png), then click **Infrastructure > Network > Routing tables**  in the Network section. The routing tables for VPC page appear.
