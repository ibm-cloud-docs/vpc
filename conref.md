...
| Boot volume | The default boot volume size for all profiles is 100 GB. You can specify a larger boot volume capacity, up to 250 GB when you're using first-generation volume profiles, and up to 32,000 GB when you're using the `sdp` profile, depending on what the image needs. You can also specify user tags. |
