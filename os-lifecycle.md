...
In the lifecycle of an operating system, end of support (EOS) is the last date that {{site.data.keyword.cloud}} delivers standard support for a given version or release of a product. The end of support date is aligned to the vendor and community support dates. It is also the effective date the product ceases to exist (is deprecated) and can no longer be ordered or purchased. 
{: shortdesc}
...
| Debian 9 minimal | 01 June 2022 | Free |
...
| RHEL 8.2 (SAP HANA & SAP applications) | 30 April 2024 | Pay-as-you-Go |
...
| Windows Server 2012 full standard | 10 January 2023 | Pay-as-you-Go / BYOL |
| Windows Server 2012 r2 full standard | 10 January 2023 | Pay-as-you-Go / BYOL |
