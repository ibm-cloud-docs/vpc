...
3. Select an image and profile for the instance. You can select an image, a snapshot of a boot volume, or an existing boot volume. Table 2 describes image, snapshot, and existing volume options. Then select a profile. Table 3 describes profile selection.
