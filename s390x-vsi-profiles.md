...
To view the list of available instance profiles by using the API, you can call the [List all instance profiles API](/docs/apis/vpc/latest#list-instance-profiles).
