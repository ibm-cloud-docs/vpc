...
* Instance profiles have a recommended number of cluster subnets. To identify IBM Cloud's recommendation for cluster subnets for a given instance type:
...
* Considerations for statically-configured IP addresses:
   ...
   * Ensure that the statically-configured IPs do not conflict. It is recommended that you let the VPC dynamically set the IP addresses on your cluster vNICs. This way, you can be assured the IPs will not conflict with any of the VPC default address prefixes.
