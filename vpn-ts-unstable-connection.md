...
1. Make sure that both sides agree on local and remote CIDR ranges and represent traffic selectors consistently. A difference in how each side configures traffic selectors can create a difference in negotiation.
