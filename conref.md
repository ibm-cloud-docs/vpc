...
| Profile |  Click **Change profile** to select from all available vCPU and RAM combinations. The profile families are Balanced, Compute, Memory, Ultra High Memory, Very High Memory, Storage Optimized, and GPU. For more information, see [Profiles](/docs/vpc?topic=vpc-profiles). |
