...
{: caption="Table 2. Quotas for access control lists" caption-side="top"}
...
{: caption="Table 3. Quotas for block storage volumes" caption-side="top"}
...
| Members | 50 per pool |
{: caption="Table 4. Quotas for load balancers" caption-side="top"}
...
{: caption="Table 5. Quotas for security groups" caption-side="top"}
...
{: caption="Table 6. Limits for VPC resources" caption-side="top"}
...
{: caption="Table 7. Quotas for the VPN service" caption-side="top"}
...
{: caption="Table 8. Quotas for virtual server instances" caption-side="top"}
