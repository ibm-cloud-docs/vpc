...
Security group integration for network load balancers
 ...
 Ultra High Memory profiles available in all regions (GA)
:   The Ultra High Memory family of profiles are now available in the Madrid (MAD) region. This makes the ux2d profiles available in all regions.
