...
For detailed information on APIs available for application load balancers in your VPC environment, see the load balancers section in the [VPC API reference](/apidocs/vpc/latest#list-all-load-balancers).
