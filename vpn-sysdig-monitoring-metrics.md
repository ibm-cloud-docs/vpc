...
4. Select **Blank dashboard** and select the type of visual representation that you want.
   ...
   Sysdig offers eight different visualizations for your dashboard. Read the description for each visualization and choose the one that best meets your requirements.
...
## Working with Sysdig using APIs
{: #metric-query-api}
