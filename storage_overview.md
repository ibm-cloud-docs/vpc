...
|---------------------|--------------------------|---------------------------|
| Availability        | Generally available in all VPC regions for all customers. | Available in the Dallas, Chennai - Airtel, Frankfurt, London, Madrid, Osaka, Sydney, Tokyo, Toronto, and Washington, DC regions for allowlisted customers.|
