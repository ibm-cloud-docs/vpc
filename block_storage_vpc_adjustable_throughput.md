...
The `sdp` profile is available to allowlisted accounts in most regions, except Montreal (`ca-mon`), and you can use it to specify custom capacity, custom throughput limit, and custom IOPS for your second-generation block storage volumes.
{: preview}
