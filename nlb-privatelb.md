...
To implement private load balancer enforcement, open an [IBM Support case](/docs/support?topic=support-using-avatar) and reference your need to alter your account to restrict the creation of floating IP addresses. After IBM processes the change, you will no longer be able to create public load balancers.
