...
# Rotating customer root keys for VPC resources to enhance security
{: #vpc-key-rotation}

Enhance security by rotating customer root keys for storage volumes, file shares, and custom images in your Virtual Private Cloud.
{: shortdesc}
