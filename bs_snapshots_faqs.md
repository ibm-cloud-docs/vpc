...
Get answers about block storage snapshots in {{site.data.keyword.vpc_short}}, including backup snapshots, consistency groups, fast restore, and cross-regional copies.
{: shortdesc}
