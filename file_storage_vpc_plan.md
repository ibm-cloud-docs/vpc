...
| Considerations|
|-------------------|
|__ Check your [IAM access permissions](/docs/iam?topic=iam-iam-service-roles-actions#is.share-roles) to verify that you can create file shares, accessor shares, bindings, and mount targets as needed.  |
