...
| Red Hat Enterprise Linux 7.x | x86-64 | Supported in the Washington DC region only. Not supported on POWER architecture. |
...
| Windows 2012, 2012 R2, 2016 | x86-64 | Supported in the Washington DC region only. Not supported on POWER architecture. |
