...
During the [Beta]{: tag-cyan} phase, you can create up to 512 manual and backup snapshots of second-generation volumes. You can even create snapshots when the `sdp` volumes are unattached.
{: beta}
