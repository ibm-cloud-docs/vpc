...
Before you begin, review [Planning considerations for VPN gateways](/docs/vpc?topic=vpc-planning-considerations-vpn).
{: important}
...
1. Select the **Navigation Menu** icon ![Menu icon](../../icons/icon_hamburger.svg), then click **VPC Infrastructure > VPNs** in the Network section.
